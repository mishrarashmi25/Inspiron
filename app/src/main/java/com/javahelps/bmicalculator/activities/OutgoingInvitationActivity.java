...
import com.javahelps.bmicalculator.network.ApiClient;
import com.javahelps.bmicalculator.network.ApiService;
...
public class OutgoingInvitationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView imageMeetingType=findViewById(R.id.imageMeetingType);
         meetingType=getIntent().getStringExtra("type");//extracting the type of meeting from intent send from main activity
